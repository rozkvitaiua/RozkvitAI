...
export function PortfolioModal({ isOpen, onClose, item }: PortfolioModalProps) {
  ...
  // ✅ щоб Portal не ламався при SSR/першому рендері
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          {/* ✅ Wrapper (центрування + скрол всередині) */}
          <div
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      {item.fullDescription ||
                        `${item.description} Проєкт був успішно реалізований з використанням найсучасніших AI-технологій. Ми застосували індивідуальний підхід та створили рішення, яке відповідає потребам клієнта.`}
                    </p>
                  </div>
  ...
  // ✅ ГОЛОВНЕ: Portal в body — це і дає вигляд “як у Figma Make”
